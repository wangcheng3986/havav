...
/*!
 @header VehiclesAbnormalAlarmDetailViewController.m
 @abstract 车辆异常报警详情界面
 @author mengy
...
@interface VehiclesAbnormalAlarmDetailViewController ()
{
    
    NSString *keyID;
    UIBarButtonItem *leftBarBtn;
    VehiclesAbnormalAlarmMessageData *mData;
}
@end

@implementation VehiclesAbnormalAlarmDetailViewController
...
- (void)viewDidLoad
{
    ...
    mData = [mCherryDBControl loadVehiclesAbnormalAlarmByKeyID:keyID];
    if ([mData.mAlarmType intValue] == 0) {

        self.navigationItem.title=[oRes getText:@"message.VehiclesAbnormalAlarmViewController.doorAbnormal"];
    }
    else
    {

        self.navigationItem.title=[oRes getText:@"message.VehiclesAbnormalAlarmViewController.TboxAbnormal"];
    }
...
-(void)initMessage
{
    ...
    NSString *type = @"";
    if ([mData.mAlarmType intValue] == 0) {
        type=[oRes getText:@"message.VehiclesAbnormalAlarmViewController.doorAbnormal"];
         NSString *messageinfo = [NSString stringWithFormat:@"%@%@%@%@%@。",[[App getInstance] searchCarNum:mData.mMessageKeyID],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.message1"],[App getDateWithTimeSince1970:mData.mAlarmTime],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.message2"],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.doorAbnormal"]];
        explainTextView.text = messageinfo;
    }
    else
    {
        type=[oRes getText:@"message.VehiclesAbnormalAlarmViewController.TboxAbnormal"];
        NSString *messageinfo = [NSString stringWithFormat:@"%@%@%@%@%@。",[[App getInstance] searchCarNum:mData.mMessageKeyID],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.message1"],[App getDateWithTimeSince1970:mData.mAlarmTime],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.message2"],[oRes getText:@"message.VehiclesAbnormalAlarmViewController.TboxAbnormal"]];
        explainTextView.text = messageinfo;
    }

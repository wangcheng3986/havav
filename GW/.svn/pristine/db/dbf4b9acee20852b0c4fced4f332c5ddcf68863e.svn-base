...
@implementation DiagnosisButton
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setTitle:[oRes getText:@"Car.vehicleDiagnosisViewController.refreshButton"] forState:UIControlStateNormal];
